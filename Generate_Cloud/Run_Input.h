...
class Run_Input
{
    ...
    Run_Input ( vector<int>const& w_r, vector<int>const& g_c_r, vector<int>const& g_r_r, vector<int>const& s_r, bool g_d_c_s, int c_s_p, string const& n_t, vector<double> n_p_r, int r );
